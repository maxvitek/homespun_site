# Django settings for homespun_site project.
...
FLOWER_CLIENT_ID = os.environ['FLOWER_CLIENT_ID']
FLOWER_CLIENT_SECRET = os.environ['FLOWER_CLIENT_SECRET']
FLOWER_USERNAME = os.environ['FLOWER_USERNAME']
...
SECRET_KEY = '^0w3s9%re!7qku)ut9@y92oi@r4qw)9il045cpgl&mel9to!#l'
...
ROOT_URLCONF = 'homespun_site.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'homespun_site.wsgi.application'
